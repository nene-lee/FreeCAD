...
#ifndef CFDGUI_WORKBENCH_H
#define CFDGUI_WORKBENCH_H
...
/**
 * The Workbench class defines a workbench for Computationl Fluid Dynamics (CFD).
 * Right now, only the incompressible flow model is considered.
 * @author Nene
 */
class CfdGuiExport Workbench : public Gui::StdWorkbench
{
	TYPESYSTEM_HEADER();
