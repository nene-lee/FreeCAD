...
#ifndef CFD_VIEW_PROVIDER_POST_OBJECT_H
#define CFD_VIEW_PROVIDER_POST_OBJECT_H
...
class CfdGuiExport ViewProviderPostObject : public Gui::ViewProviderDocumentObject,
                                               public Base::Observer<int>
{
    PROPERTY_HEADER(CfdGui::ViewProviderPostObject);

public:
    /// constructor.
    ViewProviderPostObject();
...
#endif // CFD_VIEW_PROVIDER_POST_OBJECT_H
