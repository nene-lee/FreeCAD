...
class CfdGuiExport ViewProviderPointMarker : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER(CfdGui::ViewProviderPointMarker);
...
class CfdGuiExport ViewProviderDataMarker : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER(CfdGui::ViewProviderDataMarker);
