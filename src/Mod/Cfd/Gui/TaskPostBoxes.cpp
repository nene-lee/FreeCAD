...
PROPERTY_SOURCE(CfdGui::ViewProviderPointMarker, Gui::ViewProviderDocumentObject)
...
PROPERTY_SOURCE(CfdGui::ViewProviderDataMarker, Gui::ViewProviderDocumentObject)
...
TaskPostDisplay::TaskPostDisplay(Gui::ViewProviderDocumentObject* view, QWidget *parent)
    : TaskPostBox(view, Gui::BitmapFactory().pixmap("post_pipeline"), tr("Result display options"), parent)
{
    ...
    //update all fields
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->DisplayMode, ui->Representation);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->Field, ui->Field);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->VectorMode, ui->VectorMode);

    // get Tranparency from ViewProvider
    int trans = getTypedView<ViewProviderPostObject>()->Transparency.getValue();
...
void TaskPostDisplay::on_Representation_activated(int i) {
    ...
    getTypedView<ViewProviderPostObject>()->DisplayMode.setValue(i);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->Field, ui->Field);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->VectorMode, ui->VectorMode);
}
...
void TaskPostDisplay::on_Field_activated(int i) {
    ...
    getTypedView<ViewProviderPostObject>()->Field.setValue(i);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->VectorMode, ui->VectorMode);
}

void TaskPostDisplay::on_VectorMode_activated(int i) {

    getTypedView<ViewProviderPostObject>()->VectorMode.setValue(i);
}

void TaskPostDisplay::on_Transparency_valueChanged(int i) {

    getTypedView<ViewProviderPostObject>()->Transparency.setValue(i);
}
...
TaskPostFunction::TaskPostFunction(ViewProviderDocumentObject* view, QWidget* parent): TaskPostBox(view, Gui::BitmapFactory().pixmap("fem-post-geo-plane"), tr("Implicit function"), parent) {
    ...
    assert(view->isDerivedFrom(ViewProviderPostFunction::getClassTypeId()));

    //we load the views widget
    FunctionWidget* w = getTypedView<ViewProviderPostFunction>()->createControlWidget();
    w->setParent(this);
    w->setViewProvider(getTypedView<ViewProviderPostFunction>());
...
TaskPostClip::TaskPostClip(ViewProviderDocumentObject* view, App::PropertyLink* function, QWidget* parent)
    ...
    assert(view->isDerivedFrom(ViewProviderPostClip::getClassTypeId()));
    assert(function);
    Q_UNUSED(function)
    ...
    ui->CutCells->setChecked(static_cast<Cfd::PostClipFilter*>(getObject())->CutCells.getValue());
    ui->InsideOut->setChecked(static_cast<Cfd::PostClipFilter*>(getObject())->InsideOut.getValue());
}
...
void TaskPostClip::collectImplicitFunctions() {
    ...
    pipelines = App::GetApplication().getActiveDocument()->getObjectsOfType<Cfd::PostPipeline>();
    if (!pipelines.empty()) {
        Cfd::PostPipeline *pipeline = pipelines.front();
        if(pipeline->Functions.getValue() &&
           pipeline->Functions.getValue()->getTypeId() == Cfd::PostFunctionProvider::getClassTypeId()) {

            ui->FunctionBox->clear();
            QStringList items;
            const std::vector<App::DocumentObject*>& funcs = static_cast<Cfd::PostFunctionProvider*>(
...
void TaskPostClip::on_FunctionBox_currentIndexChanged(int idx) {
        ...
        if(pipeline->Functions.getValue() &&
           pipeline->Functions.getValue()->getTypeId() == Cfd::PostFunctionProvider::getClassTypeId()) {
            ...
            const std::vector<App::DocumentObject*>& funcs = static_cast<Cfd::PostFunctionProvider*>(
                                                            pipeline->Functions.getValue())->Functions.getValues();
            if(idx>=0)
                static_cast<Cfd::PostClipFilter*>(getObject())->Function.setValue(funcs[idx]);
            else
                static_cast<Cfd::PostClipFilter*>(getObject())->Function.setValue(NULL);
        }
    }

    //load the correct view
    Cfd::PostFunction* fobj = static_cast<Cfd::PostFunction*>(
                                    static_cast<Cfd::PostClipFilter*>(getObject())->Function.getValue());
    ...
    if(view) {
        fwidget = static_cast<CfdGui::ViewProviderPostFunction*>(view)->createControlWidget();
        fwidget->setParent(ui->Container);
        fwidget->setViewProvider(static_cast<CfdGui::ViewProviderPostFunction*>(view));
...
void TaskPostClip::on_CutCells_toggled(bool val) {
    ...
    static_cast<Cfd::PostClipFilter*>(getObject())->CutCells.setValue(val);
    recompute();
}

void TaskPostClip::on_InsideOut_toggled(bool val) {

    static_cast<Cfd::PostClipFilter*>(getObject())->InsideOut.setValue(val);
    recompute();
}
...
TaskPostDataAlongLine::TaskPostDataAlongLine(ViewProviderDocumentObject* view, QWidget* parent)
    ...
    assert(view->isDerivedFrom(ViewProviderPostDataAlongLine::getClassTypeId()));
    ...
    const Base::Vector3d& vec1 = static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->Point1.getValue();
    ui->point1X->setValue(vec1.x);
    ui->point1Y->setValue(vec1.y);
    ui->point1Z->setValue(vec1.z);

    const Base::Vector3d& vec2 = static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->Point2.getValue();
    ui->point2X->setValue(vec2.x);
    ui->point2Y->setValue(vec2.y);
    ui->point2Z->setValue(vec2.z);

    int res = static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->Resolution.getValue();
...
void TaskPostDataAlongLine::on_SelectPoints_clicked() {
    ...
    if (view) {
        ...
        // require a delete.
        std::string ObjName = static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->Label.getValue();

        CfdGui::PointMarker* marker = new CfdGui::PointMarker(viewer, ObjName);
        viewer->addEventCallback(SoMouseButtonEvent::getClassTypeId(),
            CfdGui::TaskPostDataAlongLine::pointCallback, marker);
...
void TaskPostDataAlongLine::resolutionChanged(int val) {
    ...
    static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->Resolution.setValue(val);
...
void TaskPostDataAlongLine::on_Field_activated(int i) {
    ...
    static_cast<Cfd::PostDataAlongLineFilter*>(getObject())->PlotData.setValue(FieldName);
    updateEnumerationList(getTypedView<ViewProviderPostObject>()->VectorMode, ui->VectorMode);
}
...
TaskPostDataAtPoint::TaskPostDataAtPoint(ViewProviderDocumentObject* view, QWidget* parent)
    ...
    assert(view->isDerivedFrom(ViewProviderPostDataAtPoint::getClassTypeId()));
    ...
    const Base::Vector3d& vec = static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Center.getValue();
...
void TaskPostDataAtPoint::on_SelectPoint_clicked() {
    ...
    if (view) {
        ...
        // Derives from QObject and we have a parent object, so we don't
        // require a delete.
        std::string ObjName = static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Label.getValue();

        CfdGui::DataMarker* marker = new CfdGui::DataMarker(viewer, ObjName);
        viewer->addEventCallback(SoMouseButtonEvent::getClassTypeId(),
            CfdGui::TaskPostDataAtPoint::pointCallback, marker);
        connect(marker, SIGNAL(PointsChanged(double, double, double)), this, SLOT(onChange(double, double, double)));
     }
     getTypedView<ViewProviderPostObject>()->DisplayMode.setValue(1);
     updateEnumerationList(getTypedView<ViewProviderPostObject>()->Field, ui->Field);
...
void TaskPostDataAtPoint::on_Field_activated(int i) {
    ...
    getTypedView<ViewProviderPostObject>()->Field.setValue(i);
    std::string FieldName = ui->Field->currentText().toStdString();
    static_cast<Cfd::PostDataAtPointFilter*>(getObject())->FieldName.setValue(FieldName);
    if ((FieldName == "Von Mises stress") || (FieldName == "Max shear stress (Tresca)") || (FieldName == "Maximum Principal stress") || (FieldName == "Minimum Principal stress") || (FieldName == "Median Principal stress") || (FieldName == "Stress vectors")){
       static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Unit.setValue("MPa");
    }
    else if (FieldName == "Displacement"){
       static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Unit.setValue("mm");
    }
    else if (FieldName == "Temperature"){
       static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Unit.setValue("K");
    }

    std::string PointData = " The value at that location is " + std::to_string(static_cast<Cfd::PostDataAtPointFilter*>(getObject())->PointData[0]) + " " +static_cast<Cfd::PostDataAtPointFilter*>(getObject())->Unit.getValue() + "\n";
...
TaskPostScalarClip::TaskPostScalarClip(ViewProviderDocumentObject* view, QWidget* parent) :
    ...
    assert(view->isDerivedFrom(ViewProviderPostScalarClip::getClassTypeId()));
    ...
    //load the default values
    updateEnumerationList(getTypedObject<Cfd::PostScalarClipFilter>()->Scalars, ui->Scalar);
    ui->InsideOut->setChecked(static_cast<Cfd::PostScalarClipFilter*>(getObject())->InsideOut.getValue());

    App::PropertyFloatConstraint& value = static_cast<Cfd::PostScalarClipFilter*>(getObject())->Value;
...
void TaskPostScalarClip::on_Scalar_currentIndexChanged(int idx) {
    ...
    static_cast<Cfd::PostScalarClipFilter*>(getObject())->Scalars.setValue(idx);
    recompute();
...
void TaskPostScalarClip::on_InsideOut_toggled(bool val) {
    ...
    static_cast<Cfd::PostScalarClipFilter*>(getObject())->InsideOut.setValue(val);
    recompute();
}
...
TaskPostWarpVector::TaskPostWarpVector(ViewProviderDocumentObject* view, QWidget* parent) :
    ...
    assert(view->isDerivedFrom(ViewProviderPostWarpVector::getClassTypeId()));
    ...
    updateEnumerationList(getTypedObject<Cfd::PostWarpVectorFilter>()->Vector, ui->Vector);
    double warp_factor = static_cast<Cfd::PostWarpVectorFilter*>(getObject())->Factor.getValue(); // get the standard warp factor
...
void TaskPostWarpVector::on_Vector_currentIndexChanged(int idx) {
    ...
    static_cast<Cfd::PostWarpVectorFilter*>(getObject())->Vector.setValue(idx);
    recompute();
}
...
void TaskPostWarpVector::on_Slider_valueChanged(int slider_value) {
    ...
    static_cast<Cfd::PostWarpVectorFilter*>(getObject())->Factor.setValue(warp_factor);
    recompute();
...
TaskPostCut::TaskPostCut(ViewProviderDocumentObject* view, App::PropertyLink* function, QWidget* parent)
    ...
    assert(view->isDerivedFrom(ViewProviderPostCut::getClassTypeId()));
    assert(function);
    Q_UNUSED(function)
        ...
        if(pipeline->Functions.getValue() &&
           pipeline->Functions.getValue()->getTypeId() == Cfd::PostFunctionProvider::getClassTypeId()) {
            ...
            const std::vector<App::DocumentObject*>& funcs = static_cast<Cfd::PostFunctionProvider*>(
                                                            pipeline->Functions.getValue())->Functions.getValues();
            if(idx>=0)
                static_cast<Cfd::PostCutFilter*>(getObject())->Function.setValue(funcs[idx]);
            else
                static_cast<Cfd::PostCutFilter*>(getObject())->Function.setValue(NULL);
        }
    }

    //load the correct view
    Cfd::PostFunction* fobj = static_cast<Cfd::PostFunction*>(
                                    static_cast<Cfd::PostCutFilter*>(getObject())->Function.getValue());
    Gui::ViewProvider* view = NULL;
    if(fobj)
        view = Gui::Application::Instance->activeDocument()->getViewProvider(fobj);
