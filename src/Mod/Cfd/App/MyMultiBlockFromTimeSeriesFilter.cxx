/*=========================================================================
  ...
  Module:    MyMultiBlockFromTimeSeriesFilter.cxx
...
vtkStandardNewMacro(MyMultiBlockFromTimeSeriesFilter)

MyMultiBlockFromTimeSeriesFilter::MyMultiBlockFromTimeSeriesFilter()
{
  this->UpdateTimeIndex = 0;
}

MyMultiBlockFromTimeSeriesFilter::~MyMultiBlockFromTimeSeriesFilter() = default;

int MyMultiBlockFromTimeSeriesFilter::FillInputPortInformation(
...
int MyMultiBlockFromTimeSeriesFilter::RequestInformation(vtkInformation *vtkNotUsed(request),
...
int MyMultiBlockFromTimeSeriesFilter::RequestUpdateExtent(vtkInformation *vtkNotUsed(request),
...
int MyMultiBlockFromTimeSeriesFilter::RequestData(vtkInformation *request,
...
void MyMultiBlockFromTimeSeriesFilter::PrintSelf(ostream& os, vtkIndent indent)
{
