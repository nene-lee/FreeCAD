/*=========================================================================
  ...
  Module:    MyCompositeDataPipeline.h
...
=========================================================================*/
/**
 * @class   MyCompositeDataPipeline
 * @brief   Executive supporting composite datasets.
 *
 * MyCompositeDataPipeline is an executive that supports the processing of
 ...
 * MyCompositeDataPipeline is assigned to a simple filter,
...
#ifndef MyCompositeDataPipeline_h
#define MyCompositeDataPipeline_h
...
{
public:
  static MyCompositeDataPipeline* New();
  vtkTypeMacro(MyCompositeDataPipeline,vtkStreamingDemandDrivenPipeline);
...
protected:
  MyCompositeDataPipeline();
  ~MyCompositeDataPipeline() override;
...
private:
  MyCompositeDataPipeline(const MyCompositeDataPipeline&) = delete;
  void operator=(const MyCompositeDataPipeline&) = delete;
};
