...
TYPESYSTEM_SOURCE(Cfd::PropertyVtkDataObject , App::Property);

PropertyVtkDataObject::PropertyVtkDataObject()
{
}
...
void PropertyVtkDataObject::setValue(const vtkSmartPointer<vtkDataObject>& ds)
{
    aboutToSetValue();
...
const vtkSmartPointer<vtkDataObject>& PropertyVtkDataObject::getValue(void)const
{
    return m_dataObject;
}

bool PropertyVtkDataObject::isDataSet() {

	return m_dataObject && m_dataObject->IsA("vtkDataSet");
}

bool PropertyVtkDataObject::isComposite() {

    return m_dataObject && !m_dataObject->IsA("vtkCompositeDataSet");
}

bool PropertyVtkDataObject::isMultiBlock() {

	return m_dataObject && !m_dataObject->IsA("vtkMultiBlockDataSet");
}

int PropertyVtkDataObject::getDataType() {
...
PyObject *PropertyVtkDataObject::getPyObject(void)
{
    //TODO: fetch the vtk python object from the data set and return it
    return new PyObject();
}

void PropertyVtkDataObject::setPyObject(PyObject * /*value*/)
{
}

App::Property *PropertyVtkDataObject::Copy(void) const
{
    PropertyVtkDataObject *prop = new PropertyVtkDataObject();
    if (m_dataObject) {
...
void PropertyVtkDataObject::createDataObjectByExternalType(vtkSmartPointer< vtkDataObject > ex) {
...
void PropertyVtkDataObject::Paste(const App::Property &from)
{
    aboutToSetValue();
    m_dataObject = dynamic_cast<const PropertyVtkDataObject&>(from).m_dataObject;
    hasSetValue();
}

unsigned int PropertyVtkDataObject::getMemSize (void) const
{
    return m_dataObject->GetActualMemorySize();
}

void PropertyVtkDataObject::getPaths(std::vector<App::ObjectIdentifier> & /*paths*/) const
{
...
void PropertyVtkDataObject::Save (Base::Writer &writer) const
{
...
void PropertyVtkDataObject::Restore(Base::XMLReader &reader)
{
...
void PropertyVtkDataObject::SaveDocFile (Base::Writer &writer) const
{
...
void PropertyVtkDataObject::RestoreDocFile(Base::Reader &reader)
{
