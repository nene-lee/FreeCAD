...
Module:    MyCompositeDataPipeline.cxx
...
=========================================================================*/
#include "MyCompositeDataPipeline.h"
...
vtkStandardNewMacro(MyCompositeDataPipeline);

vtkInformationKeyMacro(MyCompositeDataPipeline, LOAD_REQUESTED_BLOCKS, Integer);
vtkInformationKeyMacro(MyCompositeDataPipeline, COMPOSITE_DATA_META_DATA, ObjectBase);
vtkInformationKeyMacro(MyCompositeDataPipeline, UPDATE_COMPOSITE_INDICES, IntegerVector);
vtkInformationKeyMacro(MyCompositeDataPipeline, DATA_COMPOSITE_INDICES, IntegerVector);
vtkInformationKeyMacro(MyCompositeDataPipeline, SUPPRESS_RESET_PI, Integer);
vtkInformationKeyMacro(MyCompositeDataPipeline, BLOCK_AMOUNT_OF_DETAIL,Double);


//----------------------------------------------------------------------------
MyCompositeDataPipeline::MyCompositeDataPipeline()
{
  this->InLocalLoop = 0;
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::ExecuteDataObject(
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::ExecuteDataStart(
  vtkInformation* request,
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec)
{
...
//----------------------------------------------------------------------------
// Handle REQUEST_DATA
int MyCompositeDataPipeline::ExecuteData(vtkInformation* request,
                                          vtkInformationVector** inInfoVec,
                                          vtkInformationVector* outInfoVec)
{
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::InputTypeIsValid(
...
//----------------------------------------------------------------------------
bool MyCompositeDataPipeline::ShouldIterateOverInput(vtkInformationVector** inInfoVec,
                                                      int& compositePort)
{
  compositePort = -1;
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::ExecuteEach(vtkCompositeDataIterator* iter,
                                           vtkInformationVector** inInfoVec,
                                           vtkInformationVector* outInfoVec,
                                           int compositePort,
                                           int connection,
...
void MyCompositeDataPipeline::ExecuteSimpleAlgorithm(
  vtkInformation* request,
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec,
  int compositePort)
...
//----------------------------------------------------------------------------
std::vector<vtkDataObject*> MyCompositeDataPipeline::ExecuteSimpleAlgorithmForBlock(
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec,
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::NeedToExecuteData(
  int outputPort,
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec)
{
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::NeedToExecuteBasedOnCompositeIndices(vtkInformation* outInfo)
{
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::ForwardUpstream(vtkInformation* request)
{
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::ForwardUpstream(
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::CopyDefaultInformation(
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::ResetPipelineInformation(int port,
                                                        vtkInformation* info)
{
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::PushInformation(vtkInformation* inInfo)
{
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::PopInformation(vtkInformation* inInfo)
{
...
//----------------------------------------------------------------------------
int MyCompositeDataPipeline::CheckCompositeData(
  vtkInformation *,
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec)
{
...
//----------------------------------------------------------------------------
vtkDataObject* MyCompositeDataPipeline::GetCompositeInputData(
  int port, int index, vtkInformationVector **inInfoVec)
{
  if (!inInfoVec[port])
  {
...
//----------------------------------------------------------------------------
vtkDataObject* MyCompositeDataPipeline::GetCompositeOutputData(int port)
{
...
//----------------------------------------------------------------------------
std::vector<vtkSmartPointer<vtkDataObject>> MyCompositeDataPipeline::CreateOutputCompositeDataSet(
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::MarkOutputsGenerated(
  vtkInformation* request,
  vtkInformationVector** inInfoVec,
  vtkInformationVector* outInfoVec)
{
...
//----------------------------------------------------------------------------
void MyCompositeDataPipeline::PrintSelf(ostream& os, vtkIndent indent)
{
